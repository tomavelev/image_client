...
class _$PixabayImageImpl implements _PixabayImage {
  ...
  @override
  String toString() {
    return 'PixabayImage(title: $title, id: $id, previewURL: $previewURL, webformatURL: $webformatURL, largeImageURL: $largeImageURL)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, title, id, previewURL, webformatURL, largeImageURL);
...
abstract class _PixabayImage implements PixabayImage {
  const factory _PixabayImage(
      ...
      final String? previewURL,
      final String? webformatURL,
      final String? largeImageURL}) = _$PixabayImageImpl;
